...
function _topNav () {
  ...
  jQuery('#topMain li.dropdown > a, #topMain li.dropdown-submenu > a')
  ...
  // Mega Menu
  jQuery(document)
    .bind('click', '.mega-menu .dropdown-menu', function (e) {
      e.stopPropagation();
    });
