...
app.controller('SEOCtrl', function ($scope, $rootScope, $location) {
  $rootScope.image_url = 'https://www.satprod.net/assets/images/logo-favicon.png';
  ...
  $scope.navHome = function () {
    ...
    $rootScope.description = 'Satprod is a young but powerful company that can offer you the best tools you need for your IT solution';
  };

  $scope.navContact = function () {
    $rootScope.url = 'http://www.satprod.net/#!/contact';
    $rootScope.keywords = 'satprod,satprod-group, Satprod, contact,support,assistance,customer service,service client';
    $rootScope.description = 'Satprod gives an huge importance to the customers relationships. We\'ll always be there for you!';
  };

  $scope.navCompany = function () {
    $rootScope.url = 'http://www.satprod.net/#!/company';
    $rootScope.keywords = 'satprod,satprod-group, Satprod, team, about, who we are, company, stock';
    $rootScope.description = 'Satprod is a strong company with a good reputation, we are versatile and we can adapt to your needs.';
  };
  ...
  $scope.navReferences = function () {
    ...
    $rootScope.description = 'Satprod comes with a bunch of references and experiences that will help us to succeed our chalenges with you.';
  };
  ...
  $scope.navEngineering = function () {
    ...
    $rootScope.description = 'Satprod has the ability to design, prototype and develop your engineering solutions.';
  };
  ...
  $scope.navDevelopment = function () {
    ...
    $rootScope.description = 'Over the years, Satprod develops many solutions for their clients.';
  };
